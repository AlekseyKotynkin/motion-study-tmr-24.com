...
function list_own_organizations_adminMonitorTMR(){
  ...
  ///
  var liLast_Gant = document.getElementById('adminMonitorTMR_Monitor_Gant');
  if(liLast_Gant !== null){
    liLast_Gant.remove();
  }
  ///
              ...
              '<div class="card-body">',
                ...
                '<div class="form-group row">',
                  ...
                  '<div class="col-12">',
                    ...
                    '<button type="button" class="btn btn-primary btn-lg" onclick="modal_adminMonitorTMR_TableUsers_Edit()">Select employees</button>',
                  '</div>',
                '</div>',
              '</div>',
            '</div>',
                ...
                '<div class="form-group row">',
                  ...
                  '<div class="col-12">',
                    '<input class="form-control" type="date" id="adminMonitorTMR_ActivWindows_data" name="date" style="width: 150px;" required/>',
                      '</div>',
                      '<div class="col-sm-6 col-form-label">',
                    '<button type="button" class="btn btn-primary btn-lg" onclick="modal_adminMonitorTMR_TableUsers_Edit()">Выбрать сотрудников</button>',
                  '</div>',
                '</div>',
              '</div>',
            '</div>',
...
*/
function modal_adminMonitorTMR_TableUsers_Edit(){
  ...
  if(translation_JS == null || translation_JS == 'en'){
    var html_gant = [
      '<div class="row" id = "adminMonitorTMR_Monitor_Gant">',
    ...
    .then((querySnapshot) => {
      ...
      itemListShift_local.forEach(item => {
        ...
        docRef.collection("ProcessUser").get().then((querySnapshot) => {
          ...
          k = k + 1
          if(k == k_l){
            modal_adminMonitorTMR_TableUsers_Edit_Shift();
          }
      });
        ////
      });
