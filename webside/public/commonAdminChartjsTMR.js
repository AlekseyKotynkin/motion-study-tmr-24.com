...
function toComeInButtonShift_Admin(obj) {
  ...
  .then(function(querySnapshot) {
    ...
    var getAnalysisStartDate = document.getElementById("chartjsTMR_intervai_shift_data_start").value;
    var getAnalysisStartEnd = document.getElementById("chartjsTMR_intervai_shift_data_end").value;
    ...
    if(getAnalysisStartEnd != undefined || getAnalysisStartEnd != ""){
      ...
      //   return;
      // }
      // if (yearAnalysisEndDate.length < 4){
      //   if(translation_JS == null || translation_JS == 'en'){
      //     alert('Please fill in the date according to the template!');
      //   } else {
      //     alert('Пожалуйста, заполните дату в соответствии с шаблоном!');
